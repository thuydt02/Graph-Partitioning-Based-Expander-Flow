...
public class FordFulkerson {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //create a flow network from an input file
        //String fname = "data/lucky_puck.inp"; //Right
        //String fname = "data/smallTest.inp"; //Right
        String fname = "data/5_vertices.inp"; //Right
        FlowNetwork G = new FlowNetwork(fname);
        int V = G.V();
        int E = G.E();
        int s = 0, t = V-1;
        System.out.println("The graph: /n" + G);
